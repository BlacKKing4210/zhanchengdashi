...
## 防御塔全表（2026-08-26 制作人最终基础面板）

攻击、生命、距离和间隔均为包装效果结算后的 Lv.1 最终值；运行时不得再次叠加文案中的加成。

| 名称 | 品质 | 攻击 | HP | 距离（格） | 间隔 | 技能效果 |
| --- | --- | --- | --- | --- | --- | --- |
| 兔子哨塔 | common / 2 | 1 | 5 | 2 | 1.5s | 基础防御塔，无特殊效果 |
| 猎鹰瞭望塔 | rare / 3 | 1 | 5 | 3.5 | 1.5s | 攻击距离+1.5，优先攻击远程 |
| 野猪重弩塔 | rare / 3 | 2 | 6 | 2 | 1.5s | 攻击+1 |
| 松鼠掠金塔 | rare / 3 | 1 | 7 | 2 | 1.5s | 攻击时，掠夺1金币 |
| 麻雀速弩塔 | epic / 4 | 1 | 6 | 2 | 0.5s | 攻击速度+200% |
| 龟甲壁垒塔 | epic / 4 | 1 | 21 | 2 | 1.5s | 生命值+200% |
| 鹦鹉双弩塔 | epic / 4 | 1 | 10 | 3 | 1.5s | 攻击目标+1，攻击距离+1 |
| 老虎赏金塔 | legendary / 5 | 3 | 12 | 2 | 1.5s | 攻击+2，击杀时，获得10金币 |
| 金雕领空塔 | legendary / 5 | 1 | 12 | 2 | 1.5s | 无视攻击距离，只要敌人处于我方领地上即可攻击 |
| 猛犸震地塔 | legendary / 5 | 1 | 12 | 2 | 5s | 每5秒对所有动物造成1点伤害 |
