...
func _ready() -> void:
	...
	app.set("card_counts", {"defense_territory_tower": 1, "defense_storm_obelisk": 1})
	app.set("card_levels", {"defense_territory_tower": 1, "defense_storm_obelisk": 1})
	app.set("screen", "deck")
	app.set("selected_card_id", "defense_territory_tower")
	...
	tile["site_card"] = "defense_territory_tower"
	tile["hp"] = 12.0
	tile["max_hp"] = 12.0
	...
	print("DEFENSE_TOWER_CAPTURE_PASS: %s" % output_dir)
	app.queue_free()
