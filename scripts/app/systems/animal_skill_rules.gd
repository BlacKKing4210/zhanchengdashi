...
const PROFILES = {
	...
	"出生时，对最高攻击力敌人造成6点伤害": {"spawn": "strongest_damage"},
	"远程；速度翻倍": {},
	"移动方式为冲锋": {"charge": true},
	"远程；弹射+1": {"bounce": 1},
	"击杀时，掠夺5金币": {"plunder": 5},
