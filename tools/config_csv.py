...
FIELD_LABEL_OVERRIDES = {
    ...
    "price_min_pct": "最低价格比例",
    "price_max_pct": "最高价格比例",
    "catchup_days": "最多补领天数",
    "timezone_hours": "时区偏移小时",
    "castle_gold": "城堡每日金币",
    "castle_tickets": "城堡每日抽卡券",
    "unlock_tickets": "解锁抽卡券",
    "linear_limit": "线性收益价格上限",
    "linear_divisor": "线性收益除数",
    "log_base_value": "对数收益起始值",
    "log_growth": "对数收益增速",
    "max_daily_value": "单建筑价值上限",
    "coin_min_pct": "金币最小比例",
    "coin_max_pct": "金币最大比例",
    "ticket_value": "抽卡券价值",
    "ticket_value_share": "抽卡券价值比例",
    "day_cycle_seconds": "视觉昼夜周期秒",
    "positive_mood_chance": "正面心情概率",
    "item_id": "道具ID",
    "item_name": "道具名称",
    "color": "颜色",
    "capacity_min": "最小容量",
